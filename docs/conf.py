...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.coverage', 'sphinx.ext.pngmath', 'sphinx.ext.ifconfig', 'sphinx.ext.viewcode', 'sphinxarg.ext', 'sphinxcontrib.programoutput']
...
htmlhelp_basename = 'Genologicsdoc'
